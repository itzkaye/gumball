const bundles = [
  {
    ...
    saknong: "2 saknong, 5 taludtod bawat isa",
  ...
  },
  {
    ...
    saknong: "3 saknong, 5 taludtod bawat isa",
  ...
  },
  {
    ...
    saknong: "4 saknong, 3 taludtod bawat isa",
    tugma: "Tugmaang Ganap",
    color: "#45b7d1"
  },
  {
    ...
    saknong: "3 saknong, 4 taludtod bawat isa",
    tugma: "Malayang Taludturan",
    color: "#f9ca24"
  },
  {
    ...
    saknong: "2 saknong, 6 taludtod bawat isa",
    tugma: "Tugmaang Di-Ganap",
    color: "#6c5ce7"
  },
  {
  ...
  },
  {
    ...
    saknong: "2 saknong, 4 taludtod bawat isa",
    tugma: "Malayang Taludturan",
    color: "#00b894"
  },
  {
    ...
    saknong: "4 saknong, 4 taludtod bawat isa",
    tugma: "Tugmaang Di-Ganap",
    color: "#e17055"
  }
];
...
function drawGumball() {
  ...
  setTimeout(() => {
    ...
    // Create sparkles around the gumball
    ...
    if (talinghagaEl) {
      talinghagaEl.innerHTML = pick.talinghaga
        .map(item => `<li>${item}</li>`)
        .join('');
    }
